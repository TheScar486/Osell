    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sector_industrial', models.CharField(blank=True, max_length=50, null=True)),
                ('cuenta_activa', models.BooleanField(default=True)),
                ('fecha_registro', models.DateTimeField(auto_now_add=True)),
                ('fecha_activacion', models.DateTimeField(auto_now_add=True)),
                ('fecha_expiracion', models.DateTimeField()),
                ('motivo_estado', models.CharField(blank=True, max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('empresa', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='usuarios', to='account.empresa')),
            ],
            options={
                'verbose_name': 'user',
